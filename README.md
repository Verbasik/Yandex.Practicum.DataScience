...
|---|---|---|---|
| [Исследование надёжности заёмщиков]() | Исследование факторов, влияющих на факт возврата кредита в срок, на основе статистики о платёжеспособности клиентов | `Pandas` `NumPy` | `Data Analysis`<br>`Финансовый_анализ` |
